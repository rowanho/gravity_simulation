 ...
 */
 void updateBody() {
   ...
   int* collidedWith = new int[NumberOfBodies];
   // We can only safely parallelise per bucket, as the size of number of bodies may change in the inner loop
   for (int b=0; b < 10; b++){
